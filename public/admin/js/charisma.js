...
function docReady(){
    ...
    $('.userTablasdadfasdfeOpr').click(function(e){
        e.preventDefault();
        $('#myModal').modal('show');
    });
    $('.userTableOpr').click(function(e){
        e.preventDefault();
        var usersUrl = $(this).attr('href');
        $('#ajax-modal').load(usersUrl, '', function(){
