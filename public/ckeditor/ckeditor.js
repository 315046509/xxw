...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {timestamp: "E1PE", version: "4.3.3", revision: "7841b02", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (b, e) {
            ...
            function j(a, f, n, s) {
                a = {name: b, sender: this, editor: a, data: f, listenerData: d, stop: n, cancel: s, removeListener: i};
            ...
            if (n.getListenerIndex(e) < 0) {
                ...
                j.fn = e;
                j.priority = m;
                for (var r = n.length - 1; r >= 0; r--)if (n[r].priority <= m) {
                    n.splice(r + 1, 0, j);
            ...
            once: function () {
                ...
                return function (m, j, i) {
                    var n = d(this)[m], m = b, s = a;
                    b = a = 0;
                    if (n) {
                        var r = n.listeners;
                        if (r.length)for (var r = r.slice(0), v, f = 0; f < r.length; f++) {
                            if (n.errorProof)try {
                                v = r[f].call(this,
                                    i, j, e, h)
                            } catch (q) {
                            } else v = r[f].call(this, i, j, e, h);
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (b, a) {
            ...
            for (var b = [].concat(b), a, e = [], g = 0; g < b.length; g++)if (a = b[g])/@import|[{}]/.test(a) ? e.push("<style>" + a + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + a + '">');
            return e.join("")
            ...
            if (typeof a == "function")for (var e = 0, g = b.length; e < g; e++) {
                if (a(b[e]))return e
            } else {
                if (b.indexOf)return b.indexOf(a);
                e = 0;
                for (g = b.length; e < g; e++)if (b[e] === a)return e
            }
            return-1
        }, search: function (b, a) {
            ...
            var a = b.$, e = b.base, g = b.privates || b._, d = b.proto, b = b.statics;
            !a && (a = function () {
            ...
            var e = [], g, d = CKEDITOR.tools.parseCssText(a, true, c);
            ...
            if (!e)for (g in c)if (a[g] != c[g])return false;
            return true
            ...
            for (var e = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer",
                "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], g = e.length, d; g--;) {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, e) {
            ...
            return b
        }, b = {}, c = {}, e = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, m = {"#": 1}, j = {center: 1, dir: 1, noframes: 1};
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            isEmptyInlineRemoveable: function () {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++)if (d)for (var i = 0; i < d.length; i++)b.push([a, c[j], d[i]].join("-")); else b.push([a, c[j]].join("-"));
                ...
                var b = 0, c = 0, d = this.getDocument(), j = d.getBody(), i = d.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var n = this.$.getBoundingClientRect(), s = d.$.documentElement, r = s.clientTop ||
                        j.$.clientTop || 0, v = s.clientLeft || j.$.clientLeft || 0, f = true;
                    if (CKEDITOR.env.ie) {
                ...
                i = a.getWindow();
                j = r(this, i);
                var q = r(a, i), A = this.$.offsetHeight;
                d = this.$.offsetWidth;
                ...
                for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
                    var j = c[d], i = j.nodeName.toLowerCase(), n;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var n = c.startOffset, d = c.endOffset, g, k = this.guard, l = this.type, t = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var j = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), o = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(d) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return(!b || !j.equals(a)) && (!o || !a.equals(o)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var h = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(), i = e.type == CKEDITOR.NODE_ELEMENT ? n ? e.getChild(n - 1) : null : e.getPrevious();
            ...
            if (this.current)f = this.current[t](false, l, g); else {
                if (a)f.type ==
                    CKEDITOR.NODE_ELEMENT && (f = d > 0 ? f.getChild(d - 1) : g(f, true) === false ? null : f.getPreviousSourceNode(true, l, g)); else {
                    f = e;
    ...
    (function () {
        ...
        var c = function (a) {
            ...
            a.optimizeBookmark();
            var f = a.startContainer, d = a.endContainer, g = a.startOffset, j = a.endOffset, p, k;
            if (d.type == CKEDITOR.NODE_TEXT)d = d.split(j);
            else if (d.getChildCount() > 0)if (j >= d.getChildCount()) {
            ...
            var g = f.getParents(), j = d.getParents(), l, t, h;
        ...
        {clone: function () {
            ...
            switch (a) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    var d = this.getCommonAncestor(), g = this.root, j, p, k, l, t, i = false, o, h;
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_COMMENT)l = l.getPrevious(); else {
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    h = l.getText();
                                    if (e.test(h))l = null; else for (var m = l.$.getElementsByTagName("*"), I = 0, C; C = m[I++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                        l = null;
                                        break
                                    }
                                    l && (o = !!h.length)
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_TEXT) {
                                ...
                                if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark"))if (i && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                    h = l.getText();
                                    if (e.test(h))l = null; else {
                                        m = l.$.getElementsByTagName("*");
                                        for (I = 0; C = m[I++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                            l = null;
                                            break
                                        }
                                    }
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var H, w, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), D = null, E = function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")if (D) {
                            if (D.equals(a)) {
                                D = null;
                                return
                            }
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        k = this.clone();
                        k = new CKEDITOR.dom.walker(k);
                        var z = CKEDITOR.dom.walker.whitespaces(), U = CKEDITOR.dom.walker.bookmark();
            ...
            if (!this.collapsed) {
                var a = a || CKEDITOR.SHRINK_TEXT, e = this.clone(), f = this.startContainer, d = this.endContainer, g = this.startOffset, i = this.endOffset, p = 1, k = 1;
                if (f && f.type == CKEDITOR.NODE_TEXT)if (g)if (g >= f.getLength())e.setStartAfter(f); else {
                    e.setStartBefore(f);
                    p = 0
                } else e.setStartBefore(f);
                if (d && d.type == CKEDITOR.NODE_TEXT)if (i)if (i >= d.getLength())e.setEndAfter(d); else {
                    e.setEndAfter(d);
                    k = 0
                } else e.setEndBefore(d);
                var e = new CKEDITOR.dom.walker(e), l = CKEDITOR.dom.walker.bookmark();
    ...
    (function () {
        ...
        function c(a, e, d, g) {
            ...
            if (!g)return 0;
            if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(e))return c(a, e, d, g.remaining);
            e = new CKEDITOR.dom.range(g.element);
            e.selectNodeContents(g.element);
            e = e.createIterator();
            e.enlargeBr = a.enlargeBr;
            e.enforceRealBlocks = a.enforceRealBlocks;
            e.activeFilter = e.filter = h;
            a._.nestedEditable = {element: g.element, container: d, remaining: g.remaining, iterator: e};
            return 1
        }
        ...
        a.prototype = {getNextParagraph: function (a) {
            ...
            for (this._.nextNode = null; q;) {
                var A = 0, u = q.hasAscendant("pre"), p = q.type != CKEDITOR.NODE_ELEMENT, k = 0;
                if (p)q.type == CKEDITOR.NODE_TEXT && e.test(q.getText()) && (p = 0); else {
                    var l = q.getName();
                    if (CKEDITOR.dtd.$block[l] && q.getAttribute("contenteditable") == "false") {
                        b = q;
                        c(this, a, b);
                        break
                    } else if (q.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                ...
                s = (!A || p) && q.equals(f);
                if (h && !A)for (; !q.getNext(m) && !s;) {
                    l = q.getParent();
                    if (l.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                        A = 1;
                        p = 0;
                        s || l.equals(f);
            ...
            if (!b) {
                ...
                A = {div: 1, th: 1, td: 1};
                b = b.block;
                if (!b && q && !this.enforceRealBlocks && A[q.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !q.equals(h.root))b = q; else if (!b || this.enforceRealBlocks && b.getName() == "li") {
    ...
    (function () {
                ...
                if (f = !z) {
                    a:if (a.nothingRequired)f = true; else {
                        if (z = a.requiredClasses) {
                            k = b.classes;
                            for (f = 0; f < z.length; ++f)if (CKEDITOR.tools.indexOf(k, z[f]) == -1) {
                                f = false;
                                break a
                            }
                        }
        ...
        function c(b) {
            ...
            return b._.filterFunction = function (f, d, k, l, g, p, h) {
                ...
                if (d) {
                    var o = f.name, k = d.elements[o], u = d.generic, d = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {},
                    ...
                    k = d.validClasses;
                    t = f.attributes;
                    var u = f.styles, m = t["class"], J = t.style, y, G, C = [], I = [], r = /^data-cke-/, s = false;
                    delete t.style;
                    delete t["class"];
                    if (!d.allAttributes)for (y in t)if (!p[y])if (r.test(y)) {
                        if (y != (G = y.replace(/^data-cke-saved-/, "")) && !p[G]) {
                            delete t[y];
                            s = true
                        }
                    } else {
                    ...
                    if (d.allClasses)m && (t["class"] = m); else {
        ...
        function h(a) {
            for (var b, c, e, f, d = {}, k = 1, a = y(a); b = a.match(C);) {
                ...
                d["$" + k++] = {elements: b[1], classes: c, styles: e, attributes: f};
        ...
        function f(a, b, c) {
            var e = a.name;
            if (l.$empty[e] || !a.children.length)if (e == "hr" && b == "br")a.replaceWith(r()); else {
                a.parent && c.push({check: "it", el: a.parent});
                a.remove()
            } else if (l.$block[e] || e == "tr")if (b == "br") {
        ...
        function A(a, b) {
            var c = b.getDefinition(), e = c.attributes, f = c.styles, d, k, l, g;
        ...
        var l = CKEDITOR.dtd, t = CKEDITOR.tools.copy, y = CKEDITOR.tools.trim, o = "cke-test", J = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {allow: function (a, c, e) {
            ...
            for (k in a) {
                d = a[k];
                d = typeof d == "boolean" ? {} : typeof d == "function" ? {match: d} : t(d);
                ...
                for (q in G) {
                    l[q] = b(l[q], g) || null;
                    var o = l, p = I[q], j = b(l[I[q]], g), i = l[q], A = [], u = true, m = void 0;
                    j ? u = false : j = {};
            ...
            for (l = e.length; d < l; ++d) {
                ...
                if (g.elements === true || g.elements === null) {
                    ...
                    o = g.elements;
                    delete g.elements;
                    for (f in o)if (k[f])k[f][q ? "unshift" : "push"](g); else k[f] = [g]
                }
            }
            c.elements = k;
            ...
            var k = [], g = !e && this._.rules, q = this._.transformations, o = c(this), p = this.editor && this.editor.config.protectedSource, h = false;
            a.forEach(function (a) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    a:{
                        ...
                        c = [];
                        var f, d, l;
                        if (p)for (d = 0; d < p.length; ++d)if ((l = e.match(p[d])) && l[0].length == e.length) {
                            c = true;
                            break a
                        }
            ...
            for (; t = a.pop();) {
                ...
                if (e.parent)switch (t.check) {
                    ...
                    case "el-up":
                        ...
                        break;
                    case "parent-down":
                        e.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !l[e.parent.name][e.name] && f(e.parent, d, a)
                }
            }
            return h
            ...
            if (!this.disabled && a) {
                ...
                for (f = 0; f < a.length; ++f) {
                    b = a[f];
                    var d = void 0, l = void 0, g = void 0, q = void 0, o = void 0, h = void 0;
                    c = [];
                    for (l = 0; l < b.length; ++l) {
                        ...
                        c.push({check: q == d ? null : q, left: o, right: typeof h == "string" ? k(h) : h})
                    }
                    b = d;
                    e[b] || (e[b] = []);
                    e[b].push(c)
            ...
            if (typeof a == "string") {
                ...
                d = {name: f.element, attributes: l,
                    classes: l["class"] ? l["class"].split(/\s+/) : [], styles: d, children: []}
            }
            var l = CKEDITOR.tools.clone(d), o = [], p;
        ...
        }, matchesStyle: A, transform: function (a, b) {
            if (typeof b == "string")a.name = b; else {
                var c = b.getDefinition(), e = c.styles, f = c.attributes, d, k, l, g;
                a.name = c.element;
                for (d in f)if (d ==
                    "class") {
                    c = a.classes.join("|");
    ...
    CKEDITOR.resourceManager.prototype = {add: function (a, d) {
        ...
        CKEDITOR.scriptLoader.load(g, function (a, e) {
            ...
            for (var g = 0; g < a.length; g++)for (var f = h[a[g]], q = 0; q < f.length; q++) {
                var j = f[q];
                m[j] = this.get(j);
                c[j] = 1
            }
        ...
        return function (b, c, e) {
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], m;
                    for (m in a) {
                        var s = a[m], r = s && s.requires;
                        if (!d[m]) {
                            if (s.icons)for (var v = s.icons.split(","), f = v.length; f--;)CKEDITOR.skin.addIcon(v[f], s.path + "icons/" + (CKEDITOR.env.hidpi && s.hidpi ? "hidpi/" : "") + v[f] + ".png");
                            d[m] = 1
                        }
                        if (r) {
                            r.split && (r = r.split(","));
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, g, h) {
            function m(a) {
                ...
                if (q.length > 0)for (var c = 0; c < q.length; c++) {
                    var e =
                        q[c], d = e.name, f = CKEDITOR.dtd[d], k = u.name && CKEDITOR.dtd[u.name];
            ...
            var v = new CKEDITOR.htmlParser, f = g instanceof CKEDITOR.htmlParser.element ? g : typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment, q = [], A = [], u = f, p = f.name == "textarea", k = f.name == "pre";
            v.onTagOpen = function (e, f, g, h) {
                ...
                if (a(f))q.push(f); else {
                    ...
                    if (e == "br")A.push(f); else {
                        for (; ;) {
                            h = (g = u.name) ? CKEDITOR.dtd[g] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                            if (!f.isUnknown && !u.isUnknown && !h[e])if (u.isOptionalClose)v.onTagClose(g); else if (e in b && g in b) {
                                g = u.children;
                                ...
                                "li" ? "ul" : "dl", {}, 0, 1); else if (g in d && !r(e, g)) {
                                !f.returnPoint && (f.returnPoint = u);
                                u = u.parent
                            } else {
            ...
            v.onText = function (a) {
                ...
                var e = u.name, f = e ? CKEDITOR.dtd[e] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!p && !f["#"] && e in d) {
    ...
    (function () {
        ...
        a.prototype = {add: function (a, c, e) {
            ...
            for (var d = [this.findIndex(c), 0], h = 0, m = a.length; h < m; h++)d.push({value: a[h], priority: c, options: e});
            this.rules.splice.apply(this.rules, d)
        }, findIndex: function (a) {
            for (var c = this.rules, e = c.length - 1; e >= 0 && a < c[e].priority;)e--;
            return e + 1
        }, exec: function (a, c) {
            var e = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, d = Array.prototype.slice.call(arguments, 1), h = this.rules, m = h.length, j, i, n, s;
            for (s = 0; s < m; s++) {
                if (e) {
                    j = c.type;
                    i = c.name
    ...
    (function () {
        function a(a, d) {
            ...
            function k(a, e) {
                return function (d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [], l = b(d), p, h;
                        if (l)for (o(l, 1) && k.push(l); l;) {
                            if (g(l) && (p = c(l)) && o(p))if ((h = c(p)) && !g(h))k.push(p); else {
                                f(j).insertAfter(p);
                                p.remove()
                            }
                            l = l.previous
                        ...
                        if (k = CKEDITOR.env.opera && !a || (typeof e == "function" ? e(d) !==
                            false : e))if (!j && !CKEDITOR.env.needsBrFiller && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)k = false; else if (!j && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem))k = false; else {
                            k = b(d);
            ...
            function o(a, b) {
                ...
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(A))) {
                    ...
                    if (!j)if ((c = a.previous) && c.name == "br" || !c || g(c))return true
                }
                return false
            }

            var w = {elements: {}}, j = d == "html", q = CKEDITOR.tools.extend({}, l), t;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                var a =
                    a.data, b = a.dataValue, c = new CKEDITOR.htmlParser.basicWriter;
            ...
            b.on("toDataFormat", function (a) {
                var c = a.data.dataValue, e = k.writer;
                e.reset();
        ...
        CKEDITOR.htmlDataProcessor.prototype = {toHtml: function (a, b, c, e) {
            ...
            return d.fire("toHtml", {dataValue: a,
        ...
        var A = /(?:&nbsp;|\xa0)$/, u = "{cke_protected}", p = CKEDITOR.dtd, k = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], l = CKEDITOR.tools.extend({},
            p.$blockLimit, p.$block), t = {elements: {input: m, textarea: m}}, y = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
        ...
        var G = /<(a|area|img|input|source)\b([^>]*)>/gi, I = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i, N = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
            ...
            var d = this, h, m, b = d.getFilterContext(b);
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, g = c.count(); e < g; e++) {
                a = c.getItem(e);
                if (a.getAttribute("contenteditable") == "true") {
                    d = {element: a, config: {}};
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, g = e.blockLimit, p = a.data.selection, k = p.getRanges()[0], l;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (p = d(p, e)) {
                p.appendBogus();
                l = CKEDITOR.env.ie
            }
        ...
        function g(a) {
            var b, d = a.getRanges()[0], e = a.root, g = {table: 1, ul: 1, ol: 1, dl: 1};
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element, $: function (a, b) {
            ...
            if (!b) {
                var e = /\n{2}/g;
                if (e.test(a))var k = "<" + c + ">", l = "</" + c + ">", a = k + a.replace(e, function () {
                    return l + k
                }) + l
            }
            a = a.replace(/\n/g, "<br>");
            ...
            var l, g;
            if (k)for (; (l = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[l.getName()]) && (!g || !g[e]);)if (l.getName()in CKEDITOR.dtd.span)b.splitElement(l); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
                b.setStartBefore(l);
                b.collapse(true);
                l.remove()
            ...
            var b = this.editor, d = b.activeEnterMode, b = b.getSelection(), e = b.getRanges()[0], g = a.getName(), g = CKEDITOR.dtd.$block[g];
            h(this);
            if (this.insertElementIntoRange(a, e)) {
                e.moveToPosition(a, CKEDITOR.POSITION_AFTER_END);
                if (g)if ((g = a.getNext(function (a) {
                    return c(a) && !j(a)
                })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block))g.getDtd()["#"] ? e.moveToElementEditStart(g) : e.moveToElementEditEnd(a); else if (!g && d != CKEDITOR.ENTER_BR) {
            ...
            setup: function () {
                ...
                if (!this.is("textarea")) {
                    ...
                    this.attachListener(a, "key", function (b) {
                        ...
                        if (c in p) {
                            var b = a.getSelection(), e, o = b.getRanges()[0], h = o.startPath(), j, i, m, c = c == 8;
                            if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = g(b))) {
                                ...
                                a.fire("saveSnapshot");
                                d = 1
                            } else if (o.collapsed)if ((j = h.block) && (m = j[c ? "getPrevious" : "getNext"](n)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("table") &&
        ...
        var j =
            CKEDITOR.dom.walker.bogus(), i = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, n = CKEDITOR.dom.walker.whitespaces(true), s = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var r = function () {
            ...
            function b(c, d) {
                var e, k, g, o, p = [], h = d.range.startContainer;
                e = d.range.startPath();
                for (var h =
                    ...
                    if (a(e)) {
                        g = e.getName();
                        if (s && g in CKEDITOR.dtd.$list)p = p.concat(b(e, d)); else {
                            o = !!h[g];
                            ...
                            m == -1 && !o && (m = j);
                            o || (n = j);
                            p.push({isElement: 1, isLineBreak: y, isBlock: e.isBlockBoundary(), hasBlockSibling: k, node: e, name: g, allowed: o});
                            k = y = 0
                        }
                    } else p.push({isElement: 0, node: e,
                        allowed: 1})
                }
            ...
            function d(b, c) {
                var e = [], k = b.getChildren(), g = k.count(), o, p = 0, h = l[c], j = !b.is(l.$inline) || b.is("br");
                for (j && e.push(" "); p < g; p++) {
                    o = k.getItem(p);
            ...
            var l = CKEDITOR.dtd, h = {p: 1, div: 1,
                h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, o = CKEDITOR.tools.extend({}, l.$inline);
            delete o.br;
            return function (h, i, t) {
                var n = h.editor;
                h.getDocument();
                var s = n.getSelection().getRanges()[0], r = false;
                ...
                if (!s.checkReadOnly()) {
                    var w = (new CKEDITOR.dom.elementPath(s.startContainer, s.root)).blockLimit || s.root, i = {type: i, dontFilter: r, editable: h, editor: n, range: s, blockLimit: w, mergeCandidates: [], zombies: []},
                        n = i.range, r = i.mergeCandidates, x, D, E, z;
                    ...
                    if (!n.collapsed) {
                        var w = E.block || E.blockLimit, U = n.getCommonAncestor();
                        w && (!w.equals(U) && !w.contains(U) && n.checkEndOfBlock()) && i.zombies.push(w);
                        n.deleteContents()
                    }
                    for (; (z = a(n.startContainer) &&
                    ...
                    for (w = x.startNode; (w = w.getParent()) && e(w);)r.push(w);
                    n.moveToBookmark(x);
                    if (x = t) {
                        x = i.range;
                        ...
                        if (/^\s+|\s+$/.test(t) && "span"in CKEDITOR.dtd[z])var O = '<span data-cke-marker="1">&nbsp;</span>', t = O + t + O;
                        t = i.editor.dataProcessor.toHtml(t, {context: null, fixForBody: false, dontFilter: i.dontFilter, filter: i.editor.activeFilter,
                    ...
                    if (x) {
                        v = i.range;
                        var O = v.document, B, t = i.blockLimit;
                        x = 0;
                        var K;
                        z = [];
                        var F, P, r = n = 0, L, R;
                        D = v.startContainer;
                        var w = i.endPath.elements[0], S;
                        E = w.getPosition(D);
                        ...
                        for (k(D, v); x < D.length; x++) {
                            ...
                            if (B = E.isLineBreak) {
                                ...
                                if (E.hasBlockSibling)B = 1; else {
                                    M = B.startContainer.getAscendant(l.$block, 1);
                                    if (!M || !M.is({div: 1, p: 1}))B = 0; else {
                                        V = M.getPosition(L);
                                        if (V == CKEDITOR.POSITION_IDENTICAL || V == CKEDITOR.POSITION_CONTAINS)B = 0; else {
                                            L = B.splitElement(M);
                                            B.moveToPosition(L,
                                                CKEDITOR.POSITION_AFTER_START);
                                            B = 1
                    ...
                    for (S = K.createBookmark(); F = i.zombies.pop();)if (F.getParent()) {
                        P = K.clone();
                        P.moveToElementEditStart(F);
                        P.removeEmptyBlocksAtEnd()
                    }
                    if (R)for (; F = R.pop();)CKEDITOR.env.needsBrFiller ? F.appendBogus() :
            ...
            return function (d) {
                var e =
                    d.startContainer, k = e.getAscendant("table", 1), l = false;
                ...
                if (k.is("table")) {
                    ...
                    k.is({tbody: 1, thead: 1, tfoot: 1}) && (k = b(k, "tr", l));
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                var b = e.document, c = CKEDITOR.document, f = e.editable(), k = b.getBody(), h = b.getDocumentElement(), j = f.isInline(), p, n;
                CKEDITOR.env.gecko && f.attachListener(f, "focus", function (a) {
                        a.removeListener();
                        if (p !== 0)if ((a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == f.$) {
                            a = e.createRange();
        ...
        var q = typeof window.getSelection != "function", A = 1;
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b); else if (CKEDITOR.env.gecko)b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b, true); else if (CKEDITOR.env.ie) {
                ...
                if (q)b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && m(a, null, true); else {
        ...
        var u = {img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1};
            ...
            var a = q ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, f, g, h = b.duplicate(), i = 0, j = e.length - 1, l = -1, n, p; i <= j;) {
                        ...
                        if (n > 0)j = l - 1; else if (n < 0)i = l + 1; else return{container: d, offset: a(f)}
                    }
                    ...
                    h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                    if (!h)return{container: d, offset: a(f) + (n > 0 ? 0 : 1)};
                    for (; h > 0;)try {
        ...
        if (!b) {
            ...
            this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var g = b[d], h = g.style.checkActive(a.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    g.fn.call(this, h)
                }
            })
        }
    ...
    (function () {
        ...
        function d(b) {
            ...
            if (b.collapsed) {
                ...
                var f = this.element, g = this._.definition, h, i = g.ignoreReadonly, j = i || g.includeReadonly;
                ...
                b.trim();
                var n = b.createBookmark(), l = n.startNode, m = n.endNode, o = l, r;
                if (!i) {
                ...
                for (o.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(m)) {
                        ...
                        var p = o.type == CKEDITOR.NODE_ELEMENT ? o.getName() : null, q = p && o.getAttribute("contentEditable") == "false", s = p && o.getAttribute("data-nostyle");
                        if (p && o.data("cke-bookmark")) {
                            o =
                                o.getNextSourceNode(true);
                            continue
                        }
                        if (q && j && CKEDITOR.dtd.$block[p])for (var t = o, u = c(t), y = void 0, C = u.length, G = 0, t = C && new CKEDITOR.dom.range(t.getDocument()); G < C; ++G) {
                            var y = u[G], J = CKEDITOR.filter.instances[y.data("cke-filter")];
                            if (J ? J.check(this) : 1) {
                        ...
                        if (u)if ((u = o.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(u))) {
                            ...
                            if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                for (var p = o, X; (i = !p.getNext(I)) && (X = p.getParent(), k[X.getName()]) && (X.getPosition(l) | H) == H && (!g.childRule || g.childRule(X));)p = X;
                                r.setEndAfter(p)
                            }
                    ...
                    if (i && r && !r.collapsed) {
                        for (var i = A(this, e), q = i.hasAttributes(), s = r.getCommonAncestor(), p = {}, u = {}, y = {}, C = {}, T, Q, Z; i && s;) {
                            if (s.getName() == f) {
                                ...
                                for (Q in g.styles)if (!y[Q] && (Z = s.getStyle(Q)))i.getStyle(Q) == Z ? p[Q] = 1 : y[Q] = 1
                            }
                            s = s.getParent()
                        }
        ...
        var y = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, o = {a: 1,
            embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, J = /\s*(?:;\s*|$)/, G = /#\((.+?)\)/g, I = CKEDITOR.dom.walker.bookmark(0, 1), C = CKEDITOR.dom.walker.whitespaces(1);
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, e) {
            var g = null, h = null, m = [], j = b, i, e = e || b.getDocument().getBody();
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, h = c[d ? "endContainer" : "startContainer"], m = d ? "endOffset" : "startOffset", j = g ? c.document.getById(a.startNode) : a.startNode, a = g ? c.document.getById(a.endNode) : a.endNode;
        ...
        var d = {createIterator: function () {
            ...
            return{getNextRange: function (h) {
                ...
                var m = a[g];
                if (m && a.length > 1) {
                    if (!g)for (var j = a.length - 1; j >= 0; j--)d.unshift(a[j].createBookmark(true));
                    if (h)for (var i = 0; a[g + i + 1];) {
